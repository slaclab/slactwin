"""Copied from sirepo/tests/conftest.py
...
def pytest_collection_modifyitems(session, config, items):
    ...
    codes = set((_DEFAULT_APP, "impactt"))
    import_fail = PKDict()
    os.environ["SIREPO_FEATURE_CONFIG_PACKAGE_PATH"] = f"{_DEFAULT_APP}:sirepo"
